 ...
 */
class FormVersions extends \App\Entities\FormVersions implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'titre', 'version', '' . "\0" . 'App\\Entities\\FormVersions' . "\0" . 'creator', '' . "\0" . 'App\\Entities\\FormVersions' . "\0" . 'questions', 'created', 'updated'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (FormVersions $proxy) {
     ...
     * {@inheritDoc}
     */
    public function addQuestion(\App\Entities\Questions $qestion)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addQuestion', [$qestion]);

        return parent::addQuestion($qestion);
    }
